...
define ('PHPSECINFO_TEST_MOREINFO_BASEURL', 'http://phpsec.gcosoftware.com/projects/phpsecinfo/tests/');
...
class PhpSecInfo_Test
{
    ...
    /**
	 * This is a hash of messages that correspond to publicious test result levels.
	 *
    ...
    /**
	 * Sets the $this->_message publiciable based on the passed result and language codes
	 *
	 * @param integer $result_code
	 * @param string $language_code
	 */
    ...
    function sys_get_temp_dir() {
        // Try to get from environment publiciable
        if ( !empty($_ENV['TMP']) ) {

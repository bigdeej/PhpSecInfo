 ...
 *
 * @package PhpSecInfo
 * @author Glenn S Crystal <glenn@gcosoftware.com> (2015)
 * @author Ed Finkler <coj@funkatron.com> (2007)
 */
...
//		ksort($group_results);
	...
	function _outputRenderStatsTable() {
		...
		// Calculate score
		$stats['Score'] = array( 'count' => $score,
										'result' => $this->_outputGetResultTypeFromCode(PHPSECINFO_TEST_RESULT_OK),
										'message' => $score . '%');
